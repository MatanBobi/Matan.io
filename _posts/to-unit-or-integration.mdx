---
title: To unit, or integration? That is the question
excerpt:
...
ogImage:
  url: /assets/blog/to-unit-or-integration/banner.jpeg
...
<StaticTweet id="977018512689455106" />

Since implementation details aren't something our users see, use or know about, they should not be part of our tests. I want to specifically emphasize one part of this sentence and the types of tests we need to adhere to it.
...
In order to resemble the way clients use our software, we should write integration tests that include pages, many components that interact with each other and also not forget to include the "plumbing" (eg. Data providers, Actions, Reducers and many more).  
I mean, I've never seen an app with one button, have you?
...
The bottom line is that "shared" components which are widely used within your project by other developers, should be unit tested to verify that their API works perfectly.
