...
excerpt: "StrictMode is a feature added in version 16.3 and aimed to help us in finding potential problems in an application, at the moment especially for Concurrent-Mode which is React’s ability to concurrently render, suspend, and resume rendering trees in the background while remaining interactive."
coverImage: /assets/blog/wait-youre-not-using-react-strictmode/banner.png
date: "2019-10-23T05:35:07.322Z"
author:
  name: Matan Borenkraout
  picture: /assets/blog/authors/matan.jpeg
ogImage:
  url: /assets/blog/wait-youre-not-using-react-strictmode/banner.png
tags:
  - React
  - JavaScript
hideCoverImage: true
...
![Sebastian's tweet results, 70% haven't tried StrictMode](/assets/blog/wait-youre-not-using-react-strictmode/banner.png)
...
![Code example with StrictMode wraps the whole app](/assets/blog/wait-youre-not-using-react-strictmode/1.png)
...
![Unsafe lifecycle warning](/assets/blog/wait-youre-not-using-react-strictmode/2.png)
...
![Using createRef](/assets/blog/wait-youre-not-using-react-strictmode/3.png)
...
![Warning about legacy string ref](/assets/blog/wait-youre-not-using-react-strictmode/4.png)
...
![Warning about deprecated findDOMNode](/assets/blog/wait-youre-not-using-react-strictmode/5.png)
...
![Warning about Legacy context API](/assets/blog/wait-youre-not-using-react-strictmode/6.png)
